...
/******************************************************************************
 * Consider updating src/loader/appviewtypes.h if you make changes to this file *
 ******************************************************************************/

// Libappview Prometheus support
#define APPVIEW_PROM_SUPPORT 0
...
#define CFG_FILE_NAME "appview.yml"
...
#define DEFAULT_LOG_PATH "/tmp/appview.log"
...
// Unpublished appview env vars that are not processed by config:
//    APPVIEW_APP_TYPE                 internal use only
//    APPVIEW_EXEC_TYPE                internal use only
...
//    APPVIEW_LIB_PATH                 specifies path to libappview.so library
//    APPVIEW_GO_STRUCT_PATH           for internal testing
//    APPVIEW_CLI_SKIP_HOST            for internal testing (when set skip the start/stop host operation from container)
//    APPVIEW_HTTP_SERIALIZE_ENABLE    "true" adds guard for race condition
//    APPVIEW_NO_SIGNAL                if defined, timer for USR2 is not set
//    APPVIEW_PERF_PRESERVE            "true" processes at 10s instead of 1ms
//    APPVIEW_SWITCH                   for internal go debugging
//    APPVIEW_PID                      provided by library
//    APPVIEW_PAYLOAD_HEADER           write payload headers to files
//    APPVIEW_PAYLOAD_TO_DISK          if payloads are enabled, "true" forces writes to payload->dir
//    APPVIEW_ALLOW_CONSTRUCT_DBG      allows debug inside the constructor
...
#define LD_LIB_DIR "libappview-v"

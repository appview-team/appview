...
processEnvStyleInput(config_t *cfg, const char *env_line)
{
    ...
    *env_ptr = '\0'; // Delimiting env_name
    ...
    } else if (!appview_strcmp(env_name, "APPVIEW_EVENT_SEC_NAME")) {
    ...
    } else if (!appview_strcmp(env_name, "APPVIEW_EVENT_SEC_FIELD")) {
    ...
    } else if (!appview_strcmp(env_name, "APPVIEW_EVENT_SEC_VALUE")) {
    ...
    } else if (!appview_strcmp(env_name, "APPVIEW_EVENT_SEC")) {

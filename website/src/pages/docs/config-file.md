...
`appview.yml` is the sole library configuration file in AppView.

In Cribl Edge or Cribl Stream, you can use the AppView Config Editor to create your own variants of `appview.yml` and save them in the AppView Config Library.

### appview.yml Config File

Below are the default contents of `appview.yml`:
